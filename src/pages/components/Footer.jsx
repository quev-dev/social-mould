...
export default function Footer() {
  return (
    <footer id="sec-footer" className="
    flex flex-col content-center items-center
    py-8 px-2 mt-24
    ">
      <aside className="pb-3 flex flex-row">
        <a id="quevdev-link" target="_blank" rel="noreferrer" href="https://nevinklein.netlify.app/">
          <img src={quevdev} id="quevdev" alt="QuevDev Portrait"/>
        </a>
        <p className="ml-3 relative translate-y-1">&copy; QuevDev 2023</p>
      </aside>
      <article className="pt-3">
        ...
        <h5>APIs</h5>
        <ul className="mb-4">
          <li><a target="_blank" rel="noreferrer" href="https://unsplash.com/developers">Unsplash</a></li>
        </ul>
